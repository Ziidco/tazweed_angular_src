...
if(this.selectedProject?.iconName == undefined){
        ...
        this.projectDocument = this.selectedProject.document;
        this.projectTitle = this.selectedProject.projectTitle;
        this.partnerId = this.selectedProject.partnerId;
  ...
  this.projectTitle = this.selectedProject.projectTitle.value;
  this.partnerId = this.selectedProject.partnerId.value;
