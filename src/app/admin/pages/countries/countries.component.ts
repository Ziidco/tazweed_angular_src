...
export class CountriesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.addCountryForm = new FormGroup({
      ...
      countryKey:new FormControl(null, Validators.required),
  ...
  openUpdateDialog(country){
    ...
    this.editCountryForm.get("countryCode").setValue(this.countryToEdit.countryCode)
    this.editCountryForm.get("countryKey").setValue(this.countryToEdit.countryKey)
    this.editCountryForm.get("regex").setValue(this.countryToEdit.regex)
  }
  closeUpdateDialog(){
