...
export class AllPartnersComponent implements OnInit {
  ...
  searchWithFilter() {
    ...
    if (this.filteredEmail == "") {
      ...
      this.userServ.getAllPartnersByEmail(this.filteredEmail,"admin", this.uuidValue, localStorage.getItem("auth")).subscribe(
        (response: any) => {
          console.log("all partners object ---------------------- ");
  ...
  searchWithFilterAnyWord() {
    this.showFilterHeader = false;
    
    if (this.filteredEmail == "" || this.filteredEmail == null) {
      // this.ngOnInit()
    }
    else {
      this.showLoader = true;
      console.log(this.filteredEmail);
      this.userServ.getAnyUserByAnyWord(this.filteredEmail,"admin", this.uuidValue, localStorage.getItem("auth")).subscribe(
        (response: any) => {
          console.log("all partners object ---------------------- ");
