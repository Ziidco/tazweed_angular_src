...
import { ManageServiceComponent } from '../admin/pages/manage-service/manage-service.component';
import { PartnerAccountsComponent } from '../admin/pages/partner-accounts/partner-accounts.component';
...
const routes: Routes = [
  ...
  {path:"contact",component:ContactComponent,canActivate:[KeepLoggedeGuard]},
  {path:"contactInner",component:ContactInnerComponent,canActivate:[AuthGuard]},
  ...
  {path:"dashboard",component:DashboardMasterComponent,children:[
    ...
    {path:"adminContactData",component:ContactDataComponent},
    {path:"balanceRequests",component:BalanceRequestsComponent},
    ...
    {path:"manageService/:id",component:ManageServiceComponent},
    ...
    {path:"partnerAccounts/:id",component:PartnerAccountsComponent,canActivate:[AuthGuard]},
