...
export class ManageProjectService {
  ...
  getAllProjectsForAdmin(customerType: string, X_Request_ID: string, token) {
    ...
    //projectTitle status iconName totalCost createdAt firstName lastName _id
    return this.http.get(this.baseUrl + "admin/job?fields=projectTitle,status,iconName,totalCost,createdAt,firstName,lastName,_id", { headers: headers });
  }

  getAllProjectsForAdminByClientEmail(email,customerType: string, X_Request_ID: string, token) {
    ...
    return this.http.get(this.baseUrl + "admin/job/?clientEmail=" + email, { headers: headers });
  }
  ...
  repayProjectFromCreditBalance(data,customerType: string, X_Request_ID: string, token, X_Job_Type) {
    const headers = new HttpHeaders({
      'Content-Type': 'application/json',
      'X-Customer-Type': customerType,
      'X-Request-ID': X_Request_ID,
    ...
    return this.http.put(this.baseUrl + "profile/job/pay/balance/",data, { headers: headers });


  }


  repayProjectFromCreditBalanceWithNoJobtype(data,customerType: string, X_Request_ID: string, token) {
    const headers = new HttpHeaders({
      'Content-Type': 'application/json',
      'X-Customer-Type': customerType,
      'X-Request-ID': X_Request_ID,
