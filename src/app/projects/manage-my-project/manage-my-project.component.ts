      ...
      (response: any) => {
        ...
        setTimeout(() => {
          ...
          if (this.editedProjectObject.jobType == 'article') {
            ...
            this.editProductDescForm.get("projectTitle").setValue(response.data.projectTitle);
            this.editProductDescForm.get("fieldOfProduct").setValue(response.data.fieldOfProduct);
            this.editProductDescForm.get("productOwner").setValue(response.data.productOwner);
            this.editProductDescForm.get("namesOfOtherProducts").setValue(response.data.namesOfOtherProducts);
            this.editProductDescForm.get("productFeatures").setValue(response.data.productFeatures);
            this.editProductDescForm.get("productMessage").setValue(response.data.productMessage);
            this.editProductDescForm.get("numberOfWords").setValue(response.data.numberOfWords);
            this.editProductDescForm.get("thingsToAvoid").setValue(response.data.thingsToAvoid);
            this.editProductDescForm.get("storeUrl").setValue(response.data.storeUrl);
            this.editProductDescForm.get("objectives").setValue(response.data.objectives);
            this.editProductDescForm.get("projectIdea").setValue(response.data.projectIdea);


            this.editProductDescForm.get("quantity").setValue(response.data.quantity);
            this.editProductDescForm.get("jobType").setValue(response.data.jobType);
            this.editProductDescForm.get("timePerDay").setValue(response.data.timePerDay);
            ...
            if (response.data.hasPromoCode == true) {
              ...
              this.editProductDescForm.get("promoCode").setValue(response.data.promoCode);
              this.promoCodeold = response.data.promoCode;
              // this.getPromoCodeData();
