...
import { faSignOutAlt,faFilePdf,faFileExcel,faFileImage,faFileWord,faCube, faFileAlt, faHourglassHalf, faMoneyBillWave, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
this.showLoader = false;
        ...
        if(this.selectedProject.iconName == undefined){
          ...
          this.projectId = this.selectedProject._id;
          this.profileID = this.selectedProject.clientId.value;
          for(const c of this.selectedProject.dynamicFields){
            if(c.key == 'clientEmail'){
              this.clientEmail = c.value;
            }
          }
  ...
  applyForJob() {
    ...
    console.log("apply job form ========== ");
      ...
      if(this.selectedProject.iconName == undefined){
        ...
        this.applyJobForm.get("projectTitle").setValue(this.selectedProject.projectTitle.value)
      }
