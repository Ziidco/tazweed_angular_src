...
import { faPercentage, faBuilding, faCheckCircle, faFilePdf, faEye, faCopy, faLightbulb, faUserEdit, faBriefcase, faGlobeAfrica, faBirthdayCake, faPhone, faVenusMars, faSignOutAlt, faUserAlt, faTable, faLock, faArchive, faStar, faImage } from '@fortawesome/free-solid-svg-icons';
